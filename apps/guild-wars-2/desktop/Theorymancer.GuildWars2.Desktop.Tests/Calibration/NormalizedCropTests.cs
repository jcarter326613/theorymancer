...
public sealed class NormalizedCropTests
{
    [Fact]
    public void FromScreenBounds_RoundTripsWithinTheSameClientBounds()
    {
    ...
    [Fact]
    public void FromScreenBounds_RejectsACropOutsideTheGameWindow()
    {
        var clientBounds = new ScreenBounds(100, 200, 1000, 800);
